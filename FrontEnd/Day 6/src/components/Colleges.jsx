    ...
    <div>
      ...
      <div className='top'>
        ...
        <div>
          ...
          <center><p className="pow-des">Sri Krishna Arts and Science College, also known as the SKASC Coimbatore, was established by the V.L.B. Trust in 1997 and is an ISO certified co-educational institution. SKASC has 24-hour internet access. It has science labs equipped with IBM servers.</p></center>
          <center><Link to={'/course'}><button className='btn-app'>Apply</button></Link></center>
        </div>
        </div>
        </div>
