...
const Appman = () => {
  const [users, setUsers] = useState([
    { id: 1, username: 'Arjun', email: 'ju@example.com', role: 'BE ME' },
    { id: 2, username: 'Manish', email: 'man@example.com', role: 'B.com CS' },
    { id: 3, username: 'Thakur', email: 'thak@example.com', role: 'B Tech IT' },
  ]);
